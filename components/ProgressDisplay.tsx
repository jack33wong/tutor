...
export default function ProgressDisplay({ className = '' }: ProgressDisplayProps) {
  ...
  if (stats.totalCompleted === 0) {
    return (
             <div className={`p-3 bg-gray-900 rounded-lg ${className}`}>
  ...
  return (
    <div className={`${className}`}>
      {/* Progress Summary */}
             <div className="p-3 bg-gradient-to-r from-gray-900 to-gray-800 rounded-lg border border-gray-800">
        <button
            ...
            <div>
              ...
              <div className="space-y-1">
                {recentQuestions.map((question, index) => (
                                     <div key={question.questionId} className="text-xs text-gray-300 bg-gray-950 p-2 rounded border border-gray-800">
