					...
					<div className="flex-1 overflow-y-auto p-4">
						<div className="max-w-7xl mx-auto">
							...
							<div className="mb-8">
								...
								<p className="text-gray-600 mt-2">Choose a paper to start a timed practice session</p>
							</div>
									...
									<div key={exam.id} className="card hover:shadow-md transition-shadow cursor-pointer">
										...
										<div className="space-y-3">
											...
											<div className="flex items-center justify-between text-sm">
												...
												<span className="font-medium">{Array.isArray(exam.questions) ? exam.questions.length : 0}</span>
											</div>
											<div className="flex items-center justify-between text-sm">
